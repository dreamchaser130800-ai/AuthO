...
@section('page-subtitle', 'Perbarui detail event "{{ $event->title }}"')
...
<div class="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm max-w-3xl">
    ...
    <form action="{{ route('admin.events.update', $event->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        {{-- Poster --}}
        <div>
            <label class="block text-sm font-bold text-slate-700 mb-2 uppercase tracking-wide">Ganti Poster (Opsional)</label>
